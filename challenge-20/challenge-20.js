(function (win, doc) {
    ...
    */
    //Chamado de curto circuito... ele verifica se o prompt tem resultado, e se o da esquerda for falso, ele vai receber o do lado direito
    var name = prompt('Qual o seu nome') || 'Desconhecido';
    ...
    */
    $button.addEventListener('click', function (event) {
        //Prevenir que ele enviei o formulário
    ...
    As regras para validação são:
        - me do O nousuário (antes do arroba), pode ser qualquer caractere
