(function () {
  ...
  */
  function isOperatorValid(op) {
    //vc ta testando se o objeto operation com a operação passada é valida... se ela for valida ele deve retornar uma função, se ela não for um caracter valido ele vai retornar um undefined.
    return operation[op] !== undefined;

    //vc pode usar dessa forma descrito abaixo... porque os dois !! juntos vão retornar o valor truthy ou falsy e como a function eh sempre truthy e undefined eh sempre falsy, vai da certo dessa forma tb.
    //return !!operation[op];
  ...
  function calculator(operador) {
    if (isOperatorValid(operador)) {
      return function (numero1, numero2) {
        ...
        return operation[operador](numero1, numero2);
      };
    };
    return false;
  }
