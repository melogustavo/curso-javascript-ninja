(function () {
  ...
  */
  function Person(name, lastName, age) {
    ...
    //ta usando esse arguments porque ele pediu para não passar nenhum argunto no desafio
  ...
  */
  ...
  var pessoa1 = new Person('gustavo', 'melo', 24);
  var pessoa2 = new Person('ana', 'luiza', 23);
  var pessoa3 = new Person('joao', 'silva', 40);
  console.log(pessoa1);
  console.log(pessoa2);
  console.log(pessoa3);
  ...
  */
  ...
  //encadeando métodos
  console.log(`${pessoa3.getFullName()} agora tem ${pessoa3.addAge(12).getAge()} anos`);
