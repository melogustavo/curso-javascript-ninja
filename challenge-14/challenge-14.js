(function () {
  ...
  */
  ...
  var name = ['gus', 'ta', 'vo'];
  var name1 = name.reduce(function (acumulado, atual) {
  ...
  */
  ...
  /*
  var validacao = numberObjects.some(function (item) {
    return item.number === 2;
  });
  */

  //O resultado desse if é falso porque quando vc coloca como comparação o objeto number:2 ele cria uma nova referencia a objeto que eh diferente daquela referenciada em numberObjects... ou seja, vai sempre ser false essas buscas de objeto quando se passa um objeto na unha
