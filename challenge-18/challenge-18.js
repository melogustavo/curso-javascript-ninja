(function () {
  ...
  */
  ...
  /*MINHA RESOLUÇÃO
  var regexCpf = /(\d{3})[-.\s](\d{3})[-.\s](\d+)[-.x\s]+(\d+)/;
  function cleanCPF(cpf) {
    return cpf.replace(regexCpf, function (regex, val1, val2, val3, val4) {
  ...
  */
  ...
  /*MINHA RESOLUÇÃO
  var regexFormatadoCpf = /(\d{3})(\d{3})(\d{3})(\d{2})/;
  function formatarCpf(cpf) {
    return cpf.replace(regexCpf, function (regex, val1, val2, val3, val4) {
      var cpfNoFormat = val1 + val2 + val3 + val4;
      return cpfNoFormat.replace(regexFormatadoCpf, function (regex, val1, val2, val3, val4) {
        return `${val1}.${val2}.${val3}-${val4}`;
      });
    });
  }
  console.log(formatarCpf("049-214 3421-1"));
  console.log(formatarCpf("210.458.522-05"));
  console.log(formatarCpf("735 500 794 - 22"));
  console.log(formatarCpf("101.123-131x32")); */
  ...
  */
  ...
  //cada cifrão desse se refere a tudo que está dentro do ( ) no regex
})();