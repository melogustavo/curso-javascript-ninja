(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Gustavo Melo'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'anapolino'));
  ...
  */
  ...
  frase = frase.replace(/(\w)/g, function (capturaTotal, letra) {
  ...
  */
  ...
  console.log(`O mes de março é reprentado pelo numero ${getMonthNumber('março')}`);
  console.log(`O mes de setembro é reprentado pelo numero ${getMonthNumber('setembro')}`);
  console.log(`O mes de dezembro é reprentado pelo numero ${getMonthNumber('dezembro')}`);
